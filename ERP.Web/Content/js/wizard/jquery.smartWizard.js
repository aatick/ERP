...
function SmartWizard(target, options) {
    ...
    this.buttons = {
        next: $('<a id="next-counter">' + options.labelNext + '</a>').attr("href", "#").addClass("btn btn-success"),
        previous: $('<a id="previous-counter">' + options.labelPrevious + '</a>').attr("href", "#").addClass("btn btn-primary btn-next"),
